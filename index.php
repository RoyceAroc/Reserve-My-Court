...
<body OnLoad="document.myform.txt.focus() typeWriter() " style="font-family: sans-serif">
    ...
    <script>
        window.onload = function() {
        	...
        	window.location = "http://tennis.roydero.com/LogIn.html";	
        	}
        }
    </script>
    <?php
    ...
    <form style="display: none;" method="get" action="">
        ...
        <div class="pizza">
            <table style="border: none;background-color: #31A4E1; width: 100%; height: 100%;" align="center">
                <thead>
                    <center>
                        <h1 style="color: white;background-color: #31A4E1;">Join the Online Community!</h1>
                    </center>
                </thead>
                <tbody>
                    <tr>
                        <td style="font-family: sans-serif;font-size: 17pt;text-align: left; width: 502px; color: white;">
                            <center>Name:</center>
                        </td>
                        <td style="font-family: sans-serif; font-size: 17pt; text-align: left; color: white; width: 500px;">
                            <center><input id="name" maxlength="15" id="nickname" name="uname" style="font-size: medium; width: 100px; color: #31A4E1;" required></center>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family: sans-serif;font-size: 17pt;text-align: left; width: 432px; color: white;">
                            <center>Select a recent Forum!:</center>
                        </td>
                    ...
                    <tr>
                        <td style="font-family: sans-serif;font-size: 17pt;text-align: center; color: #31A4E1; padding-top:10px;padding-bottom:10px" colspan="2">
                            <input name="enSubmit" style="width: 118px;border: none;background-color: white; height: 63px; font-size: 30pt; font-family: sans-serif; color: #31A4E1" type="submit" onclick="store()" value="Enter" >
                        </td>
                    </tr>
                </tbody>
            </table>
